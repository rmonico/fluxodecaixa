...
public class FluxodecaixaApplicationFactoryTests extends FluxodecaixaTest {
    ...
    public void should_default_properties_be_set() {
        ...
        assertEquals(FluxodecaixaApplicationFactory.EXECUTABLE_MAJOR_VERSION, Environment.get().getProperty(ApplicationPropertyKeys.EXECUTABLE_MAJOR_VERSION_PROPERTY_KEY));
        assertEquals(FluxodecaixaApplicationFactory.EXECUTABLE_MINOR_VERSION, Environment.get().getProperty(ApplicationPropertyKeys.EXECUTABLE_MINOR_VERSION_PROPERTY_KEY));
        assertEquals(FluxodecaixaApplicationFactory.EXECUTABLE_PROJECT_PHASE, Environment.get().getProperty(ApplicationPropertyKeys.EXECUTABLE_PROJECT_PHASE_PROPERTY_KEY));
    }
}
